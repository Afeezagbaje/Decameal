...
export default function FixedContainer() {
  ...
  <Grid item xs={3}>
    ...
    <img src={AppStoreImg} alt="mm" />
        ...
        <hr />
        <Grid container columns={{ xs: 3, sm: 6, md: 12 }} className="footer-socials">
          <Grid item xs={6}>
          <p>&copy; 2021 DECAMEAL, All rights reserved</p>
          </Grid>
          <Grid item xs={6}>
          <div className="social-media-accounts">
            <div className="insta"><InstagramIcon className="centered"/></div>
            <div className="twitter"><TwitterIcon className="centered"/></div>
            <div className="youtube"><YouTubeIcon className="centered"/></div>
            </div>
          </Grid>
        </Grid>
